...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : VENT_BIT_0_Pin */
  GPIO_InitStruct.Pin = VENT_BIT_0_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(VENT_BIT_0_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : VENT_BIT_1_Pin */
  GPIO_InitStruct.Pin = VENT_BIT_1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(VENT_BIT_1_GPIO_Port, &GPIO_InitStruct);
